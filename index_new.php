...
<head>
    ...
    <body>
            ...
            <div class="formulario">
                ...
                <div class="form">
                    <form id="myForm" method="post">
                        ...
                        <div>
                            <input type="text" name="apellido" id="apellido" class="nombre" required onkeydown="return validarLetras(event)" maxlength="30" tabindex="2">
                        </div>
                        <div class="content_label">
                            <label for="phone">Teléfono (Lada + Teléfono)</label>
                        </div>
                        <div class="content_phone">
                            <input type="text" name="lada" id="lada"  class="lada"  onkeydown="return validarNumeros(event)" maxlength="3" required tabindex="3">
                            <input type="text" name="phone" id="phone" class="telefono"  onkeydown="return validarNumeros(event)" maxlength="10" required tabindex="4">
                        </div>
                        <div class="content_label">
                            <label for="email">E-mail</label>
                        </div>
                        <div>
                            <input type="email" name="email" id="email" class="email" required tabindex="5">
                        </div>
                        <div class="content_label">
                            <label for="cp">Código Postal</label>
                        </div>
                        <div>
                            <input type="text" name="cp" id="cp" class="cp"  onkeydown="return validarNumeros(event)" required tabindex="6">
                        </div>
        ...
        <footer>
            ...
            <section class=" aviso">   
                <a href="http://www.gayosso.com/pdf/aviso_de_privacidad.pdf" target="_blank">Aviso de Privacidad</a>
            </section>
        </footer>
        <!--[if lt IE 7]>
